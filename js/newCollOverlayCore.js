...
function getNewCollForm () {
	...
	var formHTML= "<form method='get' id='newcoll' name='newcoll' action='mb'><table>";
	  
	formHTML = formHTML + "<tr><td>" +
	  "<div><input name='cn' type='text' style='width:" + width + "px' maxlength='" + maxCharsColl + "' " +   
	  ...
	  "<tr><td><div><textarea style='width:" + width +"px;margin-left:0px;' name='desc' id='desc' class='overlay' rows='4' onclick=\"clickclear(this, 'Description')\" onfocus=\"clickclear(this, 'Description')\" onblur=\"clickrecall(this,'Description')\" style=\"font-family:Arial\" onKeyUp=\"CheckDescLength()\">" + 
	  "Description</textarea></div></td>" +
	  "<td><div id='charsRemainingDesc'><div class='bd'></div></div>" +
	  "</td></tr></table>" + getSharedOptions() +
